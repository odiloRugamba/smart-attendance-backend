...
class Mailer {
  ...
  constructor(mailObject) {
    ...
    this.header = header || 'Welcome to SMART GATE APP';
    this.footer = this.footer || 'for more info Visit smart gate services center';
    this.buttonTemp = '';
    this.bodyStyle = '';
    this.headerStyle = '';
    this.messageStyle = '';
  ...
  `;
    ...
    const mail = {
      from: `Emmy Karangwa ${process.env.SERVER_MAIL}`,
      to: this.to,
